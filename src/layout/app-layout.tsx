...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Code', path: '/codes', entity: 'code', service: AccessServiceEnum.PROJECT, icon: FiCode },
    { name: 'Feature', path: '/features', entity: 'feature', service: AccessServiceEnum.PROJECT, icon: FiStar },
